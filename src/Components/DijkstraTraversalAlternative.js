...
export default class DijkstraTraversal extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      nodes: [
        { id: 0, x: 0, y: 0, color: "yellow" },
        { id: 1, x: 0, y: 100, color: "yellow" },
        { id: 2, x: 0, y: 200, color: "yellow" },
        { id: 3, x: 0, y: 400, color: "yellow" },
        { id: 4, x: 100, y: 0, color: "yellow" },
        { id: 5, x: 100, y: 200, color: "yellow" },
        { id: 6, x: 100, y: 300, color: "yellow" },
        { id: 7, x: 100, y: 400, color: "yellow" },
        { id: 8, x: 200, y: 0, color: "yellow" },
        { id: 9, x: 200, y: 100, color: "yellow" },
        { id: 10, x: 200, y: 300, color: "yellow" },
        { id: 11, x: 300, y: 0, color: "yellow" },
        { id: 12, x: 300, y: 200, color: "yellow" },
        { id: 13, x: 300, y: 400, color: "yellow" },
        { id: 14, x: 400, y: 0, color: "yellow" },
        { id: 15, x: 300, y: 300, color: "yellow" },
        { id: 16, x: 400, y: 300, color: "yellow" },
        { id: 17, x: 400, y: 100, color: "yellow" },
        { id: 18, x: 400, y: 200, color: "yellow" },
      ],
      edges: [
        {
          weight: 1,
  ...
  componentDidMount() {
    this.setState((prevState) => ({
      nodes: prevState.nodes.map((node) =>
        node.id === this.props.startingID
          ? { ...node, color: "blue" }
          : node.id === this.props.endingID
          ? { ...node, color: "red" }
          : node
      ),
    }));

    this.pathStack = this.getShortestPath(
