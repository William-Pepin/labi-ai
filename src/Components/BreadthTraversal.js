 ...
 * @Desc Classe permettant d'effectuer et d'affiché le parcours en largeur d'un graph
 */
export default class BreadthTraversal extends React.Component {
  /**
   * @Date 2020-10-26
   ...
   * @Date 2020-10-26
   * @Author William Pépin
   * @Desc Fonction à effectuer lorsque le composante React est bien instancié. Permet de commencer le parcour en largeur.
   * @param null
   * @returns null
   */
  componentDidMount() {
